...
/************************************************************************
Title:    Interrupt UART library with receive circular buffers
Author:   Nikolaos Tosis
Software: AVR-GCC 4.1, AVR Libc 1.4
Hardware: AT90CAN128 16MHZ 1 MBAUD
...
LICENSE:
	Copyright (C) 2014 Nikolaos Tosis
...
/**
 * @ In this Project the default baudrate is 1 MBAUD
 ...
 *  @return  none
 */
extern int uart0_putch(uint8_t data,FILE *stream);
